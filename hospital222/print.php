...
if (mysqli_num_rows($result) > 0) {
  ...
  echo "<tr><th>Patient ID</th><th>Patient Name</th><th>Doctor Name</th><th>Pathology Name</th><th>Contact</th><th>Disease</th></tr>";
    while($row = mysqli_fetch_assoc($result)) {
  echo "<tr>";
        echo "<td>". $row["P_ID"]. "</td><td>" . $row["P_Name"]. "</td><td>" . $row["D_Name"]. "</td><td>" . $row["Sample_Name"]."</td><td>".$row["Contact"]."</td><td>". $row["Disease"]. "</td>";
  echo "</tr>";
    }
echo "</table>";
} else {
...
<center> <input type="button" onclick="window.location.href='mainprint.php'" value="print"/></center>
<br><br>