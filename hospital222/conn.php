...
if (mysqli_num_rows($result) > 0) {
	...
	echo "<tr>";
        echo "<td>". $row["P_ID"]. "</td><td>" . $row["P_NAME"]. "</td><td>" . $row["Age"]. "</td><td>" . $row["Contact"]."</td><td>".$row["Address"]."</td><td>".$row["Disease"]."</td><td>"."<a href='update.php?id=".$row["P_ID"]."'>Update</a>"."/"."<a href='deletecon.php?id=".$row["P_ID"]."'>Delete</a>"."/"."<a href='reportprint1.php?id=".$row["P_ID"]."'>Pdf</a></td></tr>";
	echo "</tr>";
    }
echo "</table>";
} else {
